...
let userMulti = readline.question("What multiplication table would you like to go up to? (1 - 12): ");
...
for (a = 1; a <= userMulti; a++){
	row = [];
	for (b = 1; b <= userMulti; b++){
		row.push(a * b);
	}
	arrayTable.push(row)
}

//console.log(arrayTable[c]);
